...
%
\beq
\tau_{\rm tanh} = 0.0588_{-0.0066}^{+0.0061}\;\; (\mathrm{KDE}) 
% before extending chains
%\tau_{\rm tanh} = 0.0588_{-0.0072}^{+0.0061}\;\; (\mathrm{KDE}) 
\eeq
%
has a negligibly lower mean ($0.05\sigma$) and a 4\% larger 68\% confidence region  than the exact likelihood result 
\beq
