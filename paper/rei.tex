...
\caption{Changes in the best constrained $m_1-m_2$ PC plane between Planck 2015 (\wh{red}), Planck 2018 (blue, \texttt{SRoll2}  \wh{decide whether to have this labeled}), and Planck 2018 but with the \texttt{SimAll} likelihood (\wh{green?}).   With Planck 2018, the \texttt{SRoll2} likelihood moderately improves the best constrained direction and raises the optical depth.  }
