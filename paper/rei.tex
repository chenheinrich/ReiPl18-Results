...
data at 95\% CL.  This is in contrast to the Planck 2015 data where only a very small region is removed (see Fig.~\ref{fig:plot_m1m2_2015_vs_2018}).  \wh{Maybe add to the $\tau$ vs $\tau_{12}$ figure a version that does not have this $\tau_{12}$ cut.  Discuss more if the difference significant - also mention that even in the direct tanh constraints, the impact of taking $z\gtrsim 6$ has the effect of removing some of the low $\tau$ region.}.
