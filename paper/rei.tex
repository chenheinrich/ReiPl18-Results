...
$\Delta \tau \sim 0.0012$, a level consistent with shifts in the peaks seen in Fig.~\ref{fig:tanh}. \ch{Add $\tau(15,\zmax)$ 95\% upper limit for tanh direct MCMC and KDE.} 
...
\wh{
In the exact or in the effective likelihood approaches (ignoring these oscillations),
...
In ~\reffig{two_parameter_model_2D}, we compare the 1D and 2D marginalized posteriors of $\taulo$ and $\tauhi$.\wh{The exact, KDE and Gaussian PC treatments again agree very well.} 
...
\ch{Might need to change all simallEE labels to lowE in plots and in text}
