...
\caption{DEBUGGING - updated the KDE tanh results to have tanh dz = 0.5. Also added in faint blue lines Gaussian and convolved Gaussian with $\sigma \rightarrow \sigma$.
}
\label{fig:}
\end{figure}
...
\caption{DEBUGGING - tanh dz = 0.5 for all curves. ...)
}
\label{fig:}
\end{figure}
