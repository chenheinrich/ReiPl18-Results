...
\end{figure}
 ...
 \begin{figure}
\includegraphics[width=0.65\textwidth]{results/cosmomc_runs/two_parameter_model/tauhi_taulo_chains/pl18_tanh_highz_test2_run1_2D.pdf}
\caption{Direct MCMC chains of the two-parameter model with \tauhi and \taulo: 2D plot of \tauhi and \taulo.
}
...
\caption{PC zmax = 30 vs tanh chains with plik lite and srollv2, with ML model from two-parameter model for \tauhi restricted to $>$ 0.02 (ML model: \tauhi = 0.0206, \taulo = 0.0414).
}
