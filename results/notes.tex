...
\caption{LATEST (to be debugged) -- Added cosmomc KDE version of tau posterior computed with f = 0.14, against python versions with f = 0.1, 0.12, 0.14. They do not agree ... (Note: need to make sure python version had the same covariance matrix, and length of chain ...)
}
\label{fig:}s
\end{figure}
